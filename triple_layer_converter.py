...
if not os.path.exists("C:/Users/Kai/Documents/GitHub/pokeemerald-2/data/tilesets"):
    print(f"Given tilesets root directory does not exist: {args.tsroot}")
    print("error")
    exit(1)

primary_path = "C:/Users/Kai/Documents/GitHub/pokeemerald-2/data/tilesets/primary"
secondary_path = "C:/Users/Kai/Documents/GitHub/pokeemerald-2/data/tilesets/secondary"
...
for tileset_dir in tileset_dirs:
    ...
    if os.path.getsize(metatiles_path) != 8 * os.path.getsize(metatile_attributes_path):
        print(
            f"[SKIP] {tileset_name} skipped because metatiles.bin is not eight times the size of metatile_attributes.bin (already converted?)")
        continue
